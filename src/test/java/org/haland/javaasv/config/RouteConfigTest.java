...
class RouteConfigTest extends TestBase {
    @Test
    public void testRouteConfig_Test() throws IllegalAccessException {
        BaseConfig.setPropertyFileDir(PROPERTY_FILE_DIR_SRC_TESTS);
        RouteConfig sut = new RouteConfig();
        assertInstanceVariablesNotNull(sut);
        assertArraysNotZeroLength(sut);
    }

    @Test
    public void testRouteConfig_Runtime() throws IllegalAccessException {
